  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>OnlineShopping</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               OnlineShopping Head Office
               Email:support@onlineshoppingbd.com <br>
               Mob: 01738920277 <br>
               Dhaka 1229,Kuril,Khilkhet-ka/41 <br>
