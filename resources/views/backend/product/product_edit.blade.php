        ...
        <form method="post" action="{{route('product.update')}}" >
            ...
            <div class="row"><!-- 2nd row started -->
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_name_hin" class="form-control" required=""  value="{{ $products->product_name_hin }}"> </div>
            ...
            <div class="row"><!-- 4th row started -->
                ...
                <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_tags_hin" class="form-control" value="{{ $products->product_tags_hin }}" data-role="tagsinput" placeholder="add tags" required=""> </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_size_hin" class="form-control" value="{{ $products->product_size_hin }}" data-role="tagsinput" placeholder="add tags" > </div>
            ...
            <div class="row"><!-- 5th row started -->
                ...
                <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_color_hin" class="form-control" value="{{ $products->product_color_hin }}" data-role="tagsinput" placeholder="add tags" required=""> </div>
            ...
            <div class="row"><!-- 6th row started -->
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="selling_prize" class="form-control"  placeholder="" required="" value="{{ $products->selling_prize }}"> </div>
                                @error('selling_prize')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror 
                        </div> 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="discount_prize" class="form-control"  placeholder="" value="{{ $products->discount_prize }}"> </div>
            ...
            <div class="row"><!-- 7th row started -->
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="controls">
                        <textarea name="short_desc_en" id="textarea" class="form-control" required placeholder="Short Description..." required="">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="controls">
                        <textarea name="short_desc_hin" id="textarea" class="form-control" required placeholder="Short Description..." required="">
            ...
            <input type="submit" class="btn btn-success btn-rounded mb-5" value="Update Product">
            </div>
        </form>
    ...
    <form action="{{route('update.product.image')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row row-sm">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">
                        <a href="{{route('product.multiImage.delete',$img->id)}}" class="btn btn-sm btn-danger" id="delete" title="Delete multiImg"><i class="fa fa-trash"></i></a>
                    </h5>
                    <p class="card-text">
                        <div class="form-group">
        ...
        <div class="text-xs-right" style="text-align:center">
            <input type="submit" class="btn btn-success btn-rounded mb-5" value="Update Image">
            </div>
            <br><br>
    </form>
