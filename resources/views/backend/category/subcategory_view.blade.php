	  ...
	  <div class="container-full">
		...
		<tr>
			...
			<td class="text-center" width="20%">
				<a href="{{route('subcategory.edit',$item->id)}}" class="btn btn-info btn-sm" title="Edit subcat"><i class="fa fa-pencil"></i></a>

				<a href="{{route('subcategory.delete',$item->id)}}" class="btn btn-danger btn-sm" id="delete" title="Delete subcat"><i class="fa fa-trash"></i></a>
			</td>								
		</tr>
		@endforeach
                        </tbody>
...
<!-- ================= Category data insertion form ========================== -->
            <div class="col-4">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">SubCategory Add</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<div class="table-responsive">
