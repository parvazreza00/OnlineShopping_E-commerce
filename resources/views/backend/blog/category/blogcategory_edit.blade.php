...
<!-- ================= brand data insertion form ========================== -->
        ...
        <form method="post" action="{{ route('blog.category.update',$blogCategory->id) }}" >
            ...
            <div class="form-group">
                <h5>Blob Category Name En<span class="text-danger">*</span></h5>
                <input type="text"  name="blog_category_name_en" class="form-control" value="{{$blogCategory->blog_category_name_en}}">
				
            </div>        
        
            <div class="form-group">
                <h5>Blog Category Name Hin<span class="text-danger">*</span></h5>
            ...
            <div class="text-xs-right">
                <input type="submit" class="btn btn-success btn-rounded mb-5" value="Update Blog">
            </div>                        
