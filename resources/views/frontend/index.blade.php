            ...
            <div class="item" style="background-image: url({{asset($slider->slider_img)}});">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  ...
                  <div class="excerpt fadeInDown-2 hidden-xs"> <span>{{$slider->desc}}.</span> </div>
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="{{url('/product/details/'.$product->id.'/'.$product->product_slug_en)}}"><img  src="{{asset($product->product_thumbnail)}}" alt="" style="height:200px;width:200px"></a> </div>
                          <!-- /.image -->
@php
$amount = $product->selling_prize - $product->discount_prize;
$discount = ($amount/$product->selling_prize) * 100;
...
@endphp
                  ...
                  @else
                  <div class="tag hot"><span class="text-danger">{{ round($discount)}}%</span></div>
                  @endif
...
<button class="btn btn-primary cart-btn" type="button">Add to cart</button>
 ...
 <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishtlist(this.id)"> <i class="fa fa-heart"></i> </button>                              
...
<button class="btn btn-primary cart-btn" type="button">Add to cart</button>
 ...
 <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishtlist(this.id)"> <i class="fa fa-heart"></i> </button>                                 
                  ...
                  <!-- /.item -->
                  @empty
                  <h4 class="text-danger" style="float:right">No Data Found</h4>

                  @endforelse
                  <!-- end foreach for getting product data  -->
            ...
            @endforeach
            <!-- end foreach for getting category data -->
...
<button class="btn btn-primary cart-btn" type="button">Add to cart</button>
 ...
 <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishtlist(this.id)"> <i class="fa fa-heart"></i> </button> 
        ...
        <!-- ============================================== FEATURED PRODUCTS : END ============================================== --> 
         ...
         <!-- =============== Skip_products_0 start ============ -->
         <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">@if(session()->get('language') == 'hindi') {{$skip_category_0->category_name_hin}} @else {{$skip_category_0->category_name_en}} @endif            
          </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
<button class="btn btn-primary cart-btn" type="button">Add to cart</button>
 ...
 <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishtlist(this.id)"> <i class="fa fa-heart"></i> </button>                    
        ...
        <!-- ================ Skip_products_0: END ================ --> 
         ...
         <!-- ================== Skip_products_3 start ============ -->
         <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">@if(session()->get('language') == 'hindi') {{$skip_category_3->category_name_hin}} @else {{$skip_category_3->category_name_en}} @endif            
          </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
<button class="btn btn-primary cart-btn" type="button">Add to cart</button>
 ...
 <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishtlist(this.id)"> <i class="fa fa-heart"></i> </button>                        
        ...
        <!-- ============================================== Skip_brand_products_0 start ============================================== -->
        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">@if(session()->get('language') == 'hindi') {{$skip_brand_0->brand_name_hin}} @else {{$skip_brand_0->brand_name_en}} @endif            
          </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
<button class="btn btn-primary cart-btn" type="button">Add to cart</button>
 ...
 <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $product->id }}" onclick="addToWishtlist(this.id)"> <i class="fa fa-heart"></i> </button>                                
              ...
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="#"><img src="{{ asset($blog->post_image) }}" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
        ...
        {!! Str::limit($blog->post_details_hin, 100) !!} @else {!! Str::limit($blog->post_details_en, 100) !!} @endif</p>
