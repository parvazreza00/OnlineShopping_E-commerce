      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            @if(session()->get('language') == 'hindi') चेक आउट @else Order Tracking @endif
            </a></li>

            @auth
            <li><a href="{{route('login')}}"><i class="icon fa fa-user"></i>
           
            @if(session()->get('language') == 'hindi') उपयोगकर्ता रूपरेखा @else User Profile: {{Auth::user()->name}} @endif
            </a></li>
            @else
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              ...
              @endphp
                  ...
                  <ul class="links">                   
                    <li><a href="{{url('subsubcategory/product/'.$subsubcategory->id.'/'.$subsubcategory->subsubcategory_name_en)}}">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('order.tracking')}}">
          ...
          <div class="modal-body">
            ...
            <input type="text" name="code" class="form-control" placeholder="Your Order Invoice Number">
          </div>
