...
@endphp
	...
	<div class="col-sm-6">
		<div class="price-box">
			...
			<span class="price">${{$product->selling_prize}}</span>
			@else
			<span class="price">${{$product->discount_prize}}</span>
			<span class="price-strike">${{$product->selling_prize}}</span>
			@endif
...
<div class="col-sm-7">
	...
	<div class="product-tab">
		...
		@if(session()->get('language') == 'hindi') {!! $product->long_desc_hin !!} @else {!! $product->long_desc_en !!} @endif
...
<div class="product-reviews">
	...
	<div class="reviews">
		...
		<div class="review">
			<div class="row">
				<div class="col-md-6">
				<img src="{{ (!empty($item->user->profile_photo_path))? url('upload/user_images/'.$item->user->profile_photo_path) : url('upload/no_image.jpg')}}" alt="" style="height:40px;width:40px;border-radius: 50%;"> <b>{{$item->user->name}}</b>
...
@endif
			...
			<div class="review-title"><span class="summary">{{$item->summery}}</span><span class="date"><i class="fa fa-calendar"></i><span>{{Carbon\Carbon::parse($item->created_at)->diffForHumans()}}</span></span></div>
...
<div class="product-add-review">
	...
	<div class="review-form">
		@guest 
	<!-- if user not login show the empty form -->
	<h3>For Add product review. You need to <b><a href="{{route('login')}}">Login</a></b> first.</h3>
		@else	
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<textarea name="comments" class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder=""></textarea>
						</div><!-- /.form-group -->
					</div>
				</div><!-- /.row -->
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<span class="price"> {{ $product->selling_prize }}$</span> </div>
			@else
