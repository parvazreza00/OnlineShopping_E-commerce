  ...
  <div class='container'>
    <div class='row'>
            ...
            <div class="sidebar-widget wow fadeInUp">
              ...
              <div class="sidebar-widget-body">
                ...
                @foreach($categories as $category)
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseOne{{$category->id}}" data-toggle="collapse" class="accordion-toggle collapsed"> @if(session()->get('language') == 'hindi') {{ $category->category_name_hin }} @else {{ $category->category_name_en }} @endif </a> </div>
                    <!-- /.accordion-heading -->
              ...
              @endphp
                      ...
                      @foreach( $subcategories as $subcategory)
                        <ul>                            
                          <li><a href="{{url('subcategory/product/'.$subcategory->id.'/'.$subcategory->subcategory_name_en)}}">@if(session()->get('language') == 'hindi') {{$subcategory->subcategory_name_hin}} @else {{$subcategory->subcategory_name_en}} @endif</a></li>                        
                        </ul>
                        @endforeach
                      </div>
                      <!-- /.accordion-inner --> 
      ...
      <div class='col-md-9'> 
        ...
        @foreach($breadsubsubcat as $item)
        <span class="badge badge-secondary">{{ $item->category->category_name_en }}</span>        
        @endforeach

        @foreach($breadsubsubcat as $item)
        <span class="badge badge-secondary">{{ $item->subcategory->subcategory_name_en }}</span>        
        @endforeach

        @foreach($breadsubsubcat as $item)
        <span class="badge badge-info" style="background:green">{{ $item->subsubcategory_name_en }}</span>        
        @endforeach
