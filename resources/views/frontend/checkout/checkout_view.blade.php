	...
	<form class="register-form" action="{{ route('checkout.store') }}" method="post">
		@csrf
					  ...
					  <div class="form-group">
					    ...
					    <input type="number" name="shipping_phone" class="form-control unicase-form-control text-input" id="exampleInputEmail1" placeholder="Pnone" value="{{ Auth::user()->phone }}" required="" >
					  </div><!-- end form-group -->
					  <div class="form-group">
				...
				<div class="form-group">
					<label class="info-title" for="exampleInputEmail1"><b>Notes</b> <span>*</span></label><br>
					<textarea name="notes" id="" cols="42" rows="5" placeholder="Notes"></textarea>
				</div><!-- end form-group -->
					 ...
					 <button type="" class="btn-upper btn btn-light checkout-page-button"></button></button>
		...
		<div class="panel panel-default">
		    ...
		    <div class="">
				<ul class="nav nav-checkout-progress list-unstyled">
					...
					<li><strong>Image: </strong><img src="{{ asset($item->options->image) }}" style="height:50px;width:50px" alt=""></li>
					...
					<li>
                        ...
                        <hr>
                        <strong>Grand Amount: </strong> {{ session()->get('coupon')['total_amount'] }}
