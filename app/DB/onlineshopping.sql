...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2023 at 03:35 AM
...
CREATE TABLE `products` (
  ...
  `selling_prize` varchar(255) NOT NULL,
  `discount_prize` varchar(255) DEFAULT NULL,
  `short_desc_en` varchar(255) NOT NULL,
  `short_desc_hin` varchar(255) NOT NULL,
  `long_desc_en` text NOT NULL,
  `long_desc_hin` text NOT NULL,
...
('dXZrYzgxnszA67y6b4COC9Yz1okypAFlBv9YKIu9', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36', '', 1686313823);
